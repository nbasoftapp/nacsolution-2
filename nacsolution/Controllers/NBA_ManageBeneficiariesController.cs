...
namespace nacsolution.Controllers
{
    public class NBA_ManageBeneficiariesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var queryqirls = (from NBA_Agwy in db.NBA_Agwy select NBA_Agwy).Count();

            ViewData["girls"] = queryqirls;
            //ViewBag.marlid = db.NBA_HighSchoolQuizz.Select(p => p.HighSchoolQuiz_ID.ToString() == "Yes");
